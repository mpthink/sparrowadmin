;(function(factory) {
    ...
    var DEFAULT_ALLOWED_ATTR = _addToSet({}, [
        ...
        // XML
        'xlink:href','system:id','xlink:title','system:space','xmlns:xlink'
    ]);
    ...
    /* Output should be safe for util template engines.
    ...
    /* Keep a reference to springConfig to pass to hooks */
    var CONFIG = null;
     ...
     * _parseConfig
     *
     * @param  optional springConfig literal
     */

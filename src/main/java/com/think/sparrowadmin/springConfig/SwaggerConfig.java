...
public class SwaggerConfig {
    ...
    public Docket createRestApi(){
        return new Docket(DocumentationType.SWAGGER_2).groupName("spring-sparrowAdmin-interface")
                //加载配置信息
                .apiInfo(apiInfo())
                //设置全局参数
    ...
    private ApiInfo apiInfo() {
        Contact contact = new Contact("paul ma", "", "mpthink@163.com");
        return new ApiInfoBuilder().title("swagger 文档")
                .description("dev by paul")
                .contact(contact)
                .version("1.0.0").build();
    }
